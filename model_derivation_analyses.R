...
######################################################
## Sensitivity analysis: Splitting randomly by site ##
######################################################
...
midat_list_e2f<-mi_fun(dat=ds000,
                         split_var_name="trial",
                         trset="E",
                         teset="F",
                         mi.use=100,
                         xvars=xvars)

midat_list_f2e<-mi_fun(dat=ds000,
                       split_var_name="trial",
                       trset="F",
                       teset="E",
                       mi.use=100,
...
saveRDS(midat_list_e2f,paste0(machine,src.dir,"midat_list_e2f.RDS"))
saveRDS(midat_list_f2e,paste0(machine,src.dir,"midat_list_f2e.RDS"))
...
sav.dir<-"Faraaz PROWESS/HTE Manuscript/Results 2023/"
hte.dir<-"HTE analysis programs/"
...
midat_list0<-readRDS(paste0(machine,src.dir,"midat_list_e2f.RDS"))
...
#machine<-"C:/Users/vbtal/OneDrive - University of Pittsburgh/"
machine<-"C:/Users/VIT13/OneDrive - University of Pittsburgh/"
#saveRDS(cv,paste0(machine,src.dir,"cv_e2f.RDS"))
cv<-readRDS(paste0(machine,src.dir,"cv_e2f.RDS"))
...
midat_list0<-midat_list_f2e
ds<-ds000[ds000$trial_id %in% c("E","F"),c("y","w","trial")]
rownames(ds)<-1:nrow(ds)

# Pull out the patients in Trial E
...
mx.dst<-matrix(NA,length(tr.ids),100)
for (mm in 1:100){
  dst<-setA_list[[mm]]
...
#machine<-"C:/Users/vbtal/OneDrive - University of Pittsburgh/"
machine<-"C:/Users/VIT13/OneDrive - University of Pittsburgh/"
saveRDS(cv,paste0(machine,src.dir,"cv_f2e.RDS"))
